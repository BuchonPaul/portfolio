    ...
    <div class="projectContainer">
        ...
        <div class="projectContent">
            ...
            <div class="projectInfo">
                ...
                <div class="detailInfo">
                    <div class="detailGrid">
                        <h3 class="row1">année</h3>
                        <div id="year" class="content row1">
                            <?= $det['year'] ?>
                        </div>
                        <h3 class="row2">type</h3>
                        <div id="type" class="content row2">
                            <?= $det['type'] ?>
                        </div>
                        <h3 class="row3">Technologies</h3>
                        ...
                        if (isset($det['link'])) {
                            echo ('
                        <h3 class="row4">Liens</h3>
                        
                        <div class="content row4">
                            <a id="link" href="' . $det['link'] . '">Voir le Projet</a>
                        </div>');
                        } ?>
                    </div>
            ...
            <div class="projectFooter">
                <div id="prec">Projet Précédent</div>
                <div id="next">Projet Suivant</div>
            </div>
        </div>
        <div class="ball"></div>
